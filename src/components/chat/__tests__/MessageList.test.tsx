...
test("MessageList shows content and loading for streaming assistant message with text parts", () => {
  const messages: UIMessage[] = [
    {
      id: "1",
      role: "assistant",
  ...
  // When streaming, both text content and loading indicator are shown
